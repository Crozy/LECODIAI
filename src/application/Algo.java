...
////		
////		
////		//if(positionGoAlea == null || (positionGoAlea.x != aspi.getLayoutX() && positionGoAlea.y != aspi.getLayoutY())) {
...
//	}
//	
//	private void algoAlea(Box aspi, AnchorPane panel) {
//		if (tour >= valeurAlea2) {
//		tour = 0;
//		valeurAlea2 = 100 + aleatoire.nextInt(100);
////		if ((action.equals("avance") || action.equals("recule")) && (outils.recherche(aspi, "haut") || outils.recherche(aspi, "bas"))) {
...
//	}
//	
//	public void algoLongeMur(Box aspi, AnchorPane panel) {
//		System.out.println("Alea : " + valeurAlea);
//		System.out.println("Tour : " + tour);
//		System.out.println("Action : " + action);
//		tour++;
